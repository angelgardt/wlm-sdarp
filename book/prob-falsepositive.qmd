...
knitr::opts_chunk$set(echo=TRUE, eval=TRUE, message=FALSE, warning=FALSE, error=FALSE, cache = FALSE)
```
...
## False Positive vs False Negative {#prob-falsepositive-fp-vs-fn}

<!---![Всё так. Почти.](img/prob-falsepositive/false-negative-not-problem.png)--->
