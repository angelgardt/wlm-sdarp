...
<!--- Distributions --->
\newcommand{\disted}[1]{\overset{#1}{\thicksim}}
\newcommand{\norm}{\mathcal{N}}
...
\newcommand{\MS}{\text{MS}}
\newcommand{\MSt}{\text{MS}_\text{t}}
\newcommand{\MSr}{\text{MS}_\text{r}}
\newcommand{\MSe}{\text{MS}_\text{e}}
\newcommand{\dft}{\text{df}_\text{t}}
\newcommand{\dfr}{\text{df}_\text{r}}
\newcommand{\dfe}{\text{df}_\text{e}}
