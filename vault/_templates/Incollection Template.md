...
> Шаблон `incollection` используется для статьей или глава в книге, которая представляет собой сборник работ разных независимых авторов: энциклопедии, сборники научных трудов, антологии, где у каждой статьи свой автор, а у всей книги — редактор(ы).

> [!info] Описание полей
> `type` — тип (`incollection`), выставлен автоматически
> **Обязательные поля**
