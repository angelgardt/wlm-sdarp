...
> Шаблон `book` используется для отдельно изданных монографий или учебников, книг, написанных одним или несколькими авторами, которые изданы как единое целое.
